  ...
  <div>
          ...
          <b-container class="" style="padding-top: 10%">
            <b-row align-h="between" style="">
              <b-col lg="8" align-self="end" style="margin-right: 5%;">
                ...
                <h2 style="color: gray;">Prove it</h2>
              </b-col>
              <b-col style="">
      ...
      <div class="explainer">
        <b-row class="maket" align-h="center">
          <b-container class="" style="text-align: center">
            ...
            <br>
            <h4>
              Guesser is a prediction game built on top of Ethereum where players stake money against each other based on what outcome they believe will happen at a given event.
              <br>
    ...
    <div class="section" style="background-color: #FFFF03;">
      <div class="explainer">
        <b-row class="maket" align-h="center">
          <b-container class="" style="text-align: center">
            <h1 style="color: #ff0d73; font-weight: bold; font-size: 50px">Validate</h1>
            <h1>Who says what really happened?</h1>
            <br>
            <h4>
      ...
      <div class="explainer">
        <b-row class="maket" align-h="center">
          <b-container class="maket" style="text-align: center;">
            <h1>
              Trust the Beard<img src="../assets/beard.png" class="d-inline-block align-top" style="width: 50px;" alt="BV">
            </h1>
            <br>
            <h3 style="color: gray">
